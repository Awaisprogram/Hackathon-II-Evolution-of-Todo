          ...
          <div className="w-full max-w-lg space-y-2">
            ...
            <Card className="border-0 shadow-none bg-transparent">
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  variant="outline"
                  className="w-full h-10 sm:h-12 text-base sm:text-lg relative bg-blue-600 border-none text-white hover:text-white hover:bg-blue-500 cursor-pointer"
                  type="button"
                ...
                <form onSubmit={onCredentialSignIn} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="text-sm sm:text-base font-medium text-blue-500 hover:text-blue-400 transition-colors"
                      >
                        Forgot password?
                      </Link>
                    </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-10 sm:h-12 text-base sm:text-lg bg-blue-600 border-none text-white hover:text-white hover:bg-blue-500 cursor-pointer"
                    disabled={loading}
                    size="lg"
                  >
                    {loadingLogin ? (
