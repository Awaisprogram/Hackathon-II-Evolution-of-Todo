...
import { Loader2, Mail, MailCheck, TriangleAlert, Lock, Eye, EyeOff, User, CheckCircle } from "lucide-react";
      ...
      <div className="min-h-screen flex flex-col lg:flex-row bg-slate-950 text-slate-50">
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="w-full max-w-lg text-center space-y-6">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full shadow-lg shadow-green-500/30">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-400 max-w-md">
                Join ToDoze and start organizing your tasks efficiently.
              </p>
            </div>
          </div>
        </div>
            ...
            <Card className="border-0 shadow-none bg-transparent">
              <CardHeader className="text-center space-y-0 pb-4">
                ...
                <CardDescription className="text-base sm:text-lg mt-2 text-slate-400">
                  Join TodoApp and start organizing
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className="text-base sm:text-lg text-slate-300">
                      Confirm Password
                    </Label>
                    <div className="relative">
                      <Input
                  ...
                  <div className="flex items-start">
                    <input
                      ...
                      className="h-4 w-4 mt-1 rounded border-slate-600 bg-slate-800 text-blue-600 focus:ring-blue-500 focus:ring-offset-0"
                    />
