    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to continue to TodoApp</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 rounded border-blue-500/50 bg-slate-900/50 text-blue-600 focus:ring-blue-500 focus:ring-offset-0"
                />
              ...
              <a href="#" className="text-sm font-medium text-blue-400 hover:text-cyan-400 transition-colors">
                Forgot password?
              </a>
            </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-400">
            ...
            <a href="/register" className="font-medium text-blue-400 hover:text-cyan-400 transition-colors">
              Sign up
            </a>
          </p>
        </div>
